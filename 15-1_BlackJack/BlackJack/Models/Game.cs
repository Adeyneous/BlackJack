using BlackJack.Models.ExtensionMethods;
...
namespace BlackJack.Models
{
    public class Game : IGame
    {
        ...
        public string GetDealerHeader()
        {
            return Dealer.MustShowCards ? $"Dealer: {Dealer.Hand.Total}" : "Dealer";
        }

        public string GetPlayerHeader()
        {
            return Player.Hand.HasCards ? $"Player: {Player.Hand.Total}" : "Player";
        }
        ...
        private void Save()
        {
            ...
            session.SetObject("deck", Deck);
            session.SetObject("player", Player);
